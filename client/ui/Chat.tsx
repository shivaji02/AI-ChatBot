...
const Aside = styled.aside`
  display: flex; flex-direction: column; height: 100%; bottom:5%;width: 320px;min-height:200px; min-width: 320px; max-width: 320px; background:transparent;
    border-bottom: 1px solid #0b242bff;
...
const FooterBar = styled.div`
  ...
  background: linear-gradient(90deg, #deb512ff 50%, #095b70ff 40%);
`;

const PromptInput = styled.textarea`
  width: 100%; height: 40px; padding: 10px 12px; border-radius: 10px;
  border: 1px solid #b6bac7ff; resize: none; outline: none; font-size: 14px; line-height: 20px; background: #fff;
...
const IconBtn = styled.button<{ bg?: string }>`
  ...
  color: #fff; box-shadow: 0 2px 8px rgba(145, 114, 114, 0.08);
...
const SendIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M3 12l18-9-5 18-5-6-8-3z" stroke="black" strokeWidth="1.6"  fill='none'/>
  </svg>
);

const Meta = () => (
  <svg width="21" height="20" viewBox="0 -5 24 24" fill="none" aria-hidden="true">
    <path d="M3 12l18-9-5 8-5-6-8-3z" stroke="black" strokeWidth="2.2" fill="none" />
  </svg>
);
